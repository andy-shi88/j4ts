...
public final class LongHelper extends NumberHelper implements Comparable<LongHelper> {
	...
	public static String toUnsignedString(long i, int radix) throws Exception {
		if (i >= 0)
			return toString(i, radix);
		else {
			throw new Exception("toUnsignedString i < 0");
		}
	}
	...
	public static long parseUnsignedLong(String s, int radix)
		...
		if (len > 0) {
			...
			throw new NumberFormatException(String.format("%s length less than 0", s));
		}
	}
